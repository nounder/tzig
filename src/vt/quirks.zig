...
//   upstream: src/quirks.zig
//   commit:   c74f6d56d1feef473033057bc0ff7e3f00cf6421
//   pruned:   removed font/Face dependency; only inlineAssert kept
...
// tzig: removed disableDefaultFontFeatures and the `font` import. tzig
// has no font shaping, so the only thing we use from quirks.zig is
// inlineAssert.
