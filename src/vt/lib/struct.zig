    ...
    return switch (target) {
        ...
        .c => c: {
            ...
            for (info.fields, 0..) |field, i| {
                ...
                // Resolve null alignments to the natural alignment of the
                // field type, since `extern` structs need explicit alignment.
                // In 0.16 `field.alignment` is `?usize` (null == unset).
                const align_value: usize = field.alignment orelse @alignOf(field.type);
                field_attrs[i] = .{
